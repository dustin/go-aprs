...
func TestCapture(t *testing.T) {
	...
	expected := []aprs.APRSData{
		aprs.APRSData{Source: aprs.Address{Call: "N6WKZ", SSID: 3},
			Dest: aprs.Address{Call: "APU25N", SSID: 0},
			Path: []aprs.Address{aprs.Address{Call: "WR6ABD", SSID: 0}},
			Body: "=3746.42N112226.00W# {UIV32N}\r"},
		aprs.APRSData{Source: aprs.Address{Call: "W1EJ", SSID: 10},
		...
		aprs.APRSData{Source: aprs.Address{Call: "CARSON", SSID: 0},
		...
		aprs.APRSData{Source: aprs.Address{Call: "KE6KYI", SSID: 0},
			Dest: aprs.Address{Call: "APU25N", SSID: 0},
		...
		aprs.APRSData{Source: aprs.Address{Call: "KG6ZLQ", SSID: 12},
		...
		aprs.APRSData{Source: aprs.Address{Call: "W6SIG", SSID: 0},
		...
		aprs.APRSData{Source: aprs.Address{Call: "KI6ASH", SSID: 0},
